/**
 * Página principal para gestión de Job Families
 */

import React from 'react';
import { useMultiTenant } from '../hooks/useMultiTenant';
import { useAuth } from '../context/AuthContext';
import JobFamilyManager from '../components/jobfamily/JobFamilyManager';
    ...
    return (
      <div className="max-w-4xl mx-auto p-6">
        <Alert type="error">
          ...
          <Alert.Description>
            Debes iniciar sesión para acceder a las Job Families.
          </Alert.Description>
        </Alert>
      </div>
    );
